...
from components.material import ChequeredMaterial, Material
from components.objects3D import Plane, Sphere
from components.scene import Scene
from components.vectors import Color, Point, Vector3
...
def generate_3d_image(json_path: str = "", image_out: str = "out.ppm", 
    ...
    if True:
        ...
        # I use this one a lot for tests and haven't saved it in a json yet, so i'll leave it here for now
        parser = argparse.ArgumentParser()
        ...
        OBJECTS = [
            ...
            # Pink ball
            Sphere(Point(-0.75, -0.1, 2.25), 0.6, Material(Color.fromHex("#803980"), 0, 0, 0.5, 0.1, 2000, 0.9, 1.52)),
            # Chequered ball
