...
class ChequeredMaterial(Material):
    ...
    def __init__(self, color1=Color.fromHex('#FFFFFF'), color2=Color.fromHex('#000000'),
        ambient=0.05, diffuse=1, specular=1, reflection=0.5, phong=50, transmission=0, refraction=1.52) -> None:
        self.color1 = color1
        self.color2 = color2
        self.ambient = ambient
        self.diffuse = diffuse
